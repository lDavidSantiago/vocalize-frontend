...
/**
 * usePitchDetector.tsx
 *
 * @author lDavidSantiago
 * @date November 20, 2025
 * @description Real-time pitch detection component using Web Audio API and Pitchy library.
 * Monitors microphone input and displays detected pitch frequency and clarity percentage.
 *
 * @dependencies
 *   - pitchy: Pitch detection algorithm
 *   - react: UI framework
